...
[Market](#market) type. Displayed as [coin code](#coin-code). e. g. Bitcoin as "BTC" and Ethereum as "ETH"
...
[Currency](#currency) type. Displayed as [coin code](#coin-code). e. g. Bitcoin as "BTC" and Ethereum as "ETH"
...
Display name of [Currency](#currency)
...
[Coin-pair](#coin-pair) type. String concatenation of `marketType` and `coinType` with a dot (.)
